...
\begin{frame}{Conclusions}
    ...
    \begin{block}{Philosophical Interest?}
        ...
        potentialist view seems to be second order arithmetic + topological regularity.

        \onslide<7-> The theory is up to interpreting ZFC in fairly natural `inner models'

        \onslide<8-> Conventionally, it is the regularity properties that are taken 
        to hold in `inner models'

        \onslide<9-> A peculiar sort of necker cube effect. Of philosophical interest?
    \end{block}
\end{frame}
