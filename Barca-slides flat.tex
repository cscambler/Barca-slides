...
\begin{frame}
    ...
    \begin{block}{Set-theoretic axioms}
        ...
        \item<11-> $\Box \forall \mathbb{P}, X [D(\mathbb{P}, X)\rightarrow \dl \exists g[Fmeets(g, xx)]]$
...
\begin{frame}
    ...
    \onslide<11->
\begin{block}{Theorem}
  $\mathsf{M} \vdash \varphi$ implies $\mathsf{T} \vdash \forall r, X[ r \in \mathbb{R} \wedge Tran(X) \rightarrow t(\varphi)(X, r)]$  
\end{block}
\end{frame}
\begin{frame}
    \frametitle{Converse Translation}
